        ...
        if(is_null($this->connection)) {
           return false;
            ...
            try {
                ...
                $stmt = null;
                unset($this->connection);
                echo "Error!: falha ao preparar consulta SELECT beneficio: <pre><code>" . $p->getMessage() . "</code></pre> </br>";
                return false;
            }
        }
    }
